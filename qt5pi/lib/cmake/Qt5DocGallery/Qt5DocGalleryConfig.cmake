...
macro(_populate_DocGallery_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::DocGallery PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5DocGallery_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        "IMPORTED_SONAME_${Configuration}" "libQt5DocGallery.so.0"
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5DocGallery_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::DocGallery)
    ...
    _populate_DocGallery_target_properties(RELEASE "libQt5DocGallery.so.0.0.0" "" )
