...
macro(_populate_PublishSubscribe_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::PublishSubscribe PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5PublishSubscribe_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        "IMPORTED_SONAME_${Configuration}" "libQt5PublishSubscribe.so.5"
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5PublishSubscribe_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::PublishSubscribe)
    ...
    _populate_PublishSubscribe_target_properties(RELEASE "libQt5PublishSubscribe.so.5.4.0" "" )
